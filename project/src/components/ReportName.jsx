...
const ReportName = () => {
    ...
    const getFullReportData = async () => {
        try {
            let result = await fetch(`${nURL}/reports/${index}/full`);
            ...
            if(data){
                ...
                // setReportPages(data?.scope[0]?.page_count);
                // setReportCovers(data?.scope[0]?.page_count)
            }
        }
        catch (err) {
    ...
    return (
        <>
            <div className="border w-80 sm:w-160 lg:w-198 xl:w-285 m-auto mt-6 mb-11">
                <div className="flex gap-6 items-start">
                    <div className="border w-80 sm:w-160 lg:w-198">
                        <div className=" flex gap-2 text-primary text-16 font-regular">
                            <span>Home</span>
                            <span>&gt;</span>
                            <span>Reports</span>
                        ...
                        {/*  */}
                        <div className="border flex gap-1.5 xl:gap-4 mt-6">
                            <div className="border-2 w-24 h-32 flex-shrink-0 hidden sm:block"><img src={frame48} alt="image" className=' w-24 h-32' /></div>
                            <div className="border">
                                <h1 className='text-primary text-32 font-semibold'>Canada Nail Colour and Care Market Report 2025</h1>
                                <p className='text-primary text-16 font-regular mt-2'>Lorem ipsum dolor sit amet consectetur. Libero aliquet sagittis et pellentesque. Sapien elit a neque faucibus fringilla nec sodales. Adipiscing cursus duis cras nam vulputate condimentum. Nunces.</p>
                                <div className="border flex gap-2 mt-2">
                        ...
                        <div className="border m-auto my-4 w-80 block xl:hidden">
                            <div className="border w-80">
                                ...
                                <div className="border bg-brand h-10 mt-5 w-full">
                                    <button className='border h-full w-full text-15 font-medium text-primary cursor-pointer' onClick={() => setPopupOpen(true)}>Buy This Report</button>
                                </div>
                            </div>

                            {/* price card 2 */}
                            <div className="border w-80 mt-6">
                                <div className="flex gap-2 items-center pb-3">
                                    <h1 className='text-primary text-20 font-medium'>Customize Your Report</h1>
                                </div>
                                <div className="border mt-2 flex flex-col gap-2">
                        ...
                        {/* tabs */}
                        <div className="border w-80 sm:w-160 lg:w-198 flex gap-2 mt-3">
                            <TabButton
                                label="Scope & Coverage"
                                isActive={activeTab === "Scope & Coverage"}
                                onClick={() => setActiveTab("Scope & Coverage")}
                        ...
                        <div className='border  w-80 sm:w-160 lg:w-198 p-0 xl:p-6'>
                            {activeTab === "Scope & Coverage" && <ScopeCoverage setPopupOpen={setPopupOpen} />}
                            {activeTab === "Table of Content" && <TableContent />}
                            {activeTab === "Sample Preview" && <SamplePreview />}
                            {activeTab === "Methodology" && <Methodology />}
                        </div>
            ...
            {/* contact form */}
            <ContactForm popupOpen={popupOpen} setPopupOpen={setPopupOpen} />
        </>
    );
};
export default ReportName;
