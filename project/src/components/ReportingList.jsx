...
// import reportingImg from '../assets/reportListing.svg';
...
//                 console.log("industryparams: ", industryParam);
//                 const decodedIndustry = decodeURIComponent(industryParam);

//                 url = `${base_url}/industries/${decodedIndustry}`;
//                 options = {
//                     method: "GET"
//                 };
//             } else {
//                 url = `${base_url}/reports/filter/display`;
//                 options = {
//                     method: "POST",
//                     headers: { "Content-Type": "application/json" },
//                     body: JSON.stringify(selectedFilters)
...
//             let listResult = await fetch(url, options);
...
//              reportlisting-bg-img"
//                 style={{
//                     backgroundImage: `url(${industryParam && mainImage
//                             ? mainImage                // API image
//                             : reportingImg     // Static image
//                         })`,
//                 }}
//             >
//                 <div className=" w-80 sm:w-140 xl:w-285 m-auto flex gap-5 justify-center">
...
//                                 {industryParam ? mainTitle : "All Reports"}
//                             </h1>

//                             <p className="text-primary text-16 font-regular mt-2">
//                                 {/* Comprehensive market trends, consumer analysis, and competitive landscape reports. */}
//                                 {industryParam ? mainSubTitle : "All Reports subtitle"}
//                             </p>
//                         </div>
//                         <div className=" flex flex-col gap-4">
//                             <div className=" flex gap-14">
