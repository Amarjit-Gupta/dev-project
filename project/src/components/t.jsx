...
const ReportingList = () => {
    ...
    return (
        <>
            ...
            <div className="border max-w-285 m-auto mb-11.5">


                <div className="border max-w-285 m-auto grid grid-cols-[22%_auto] gap-7.5">
                    ...
                    <div className="border">
                        ...
                        <div className="border flex justify-between items-center">
                            <div className="border"><h1 className="text-primary text-20 font-medium">234 reports available</h1></div>
                            <div className="border flex gap-8">
                                ...
                                <div className="border w-56 h-10.5 px-6 py-2 flex gap-2">
                                    <img src={AZ} alt="" />
                        ...
                        {/* grid view */}
                        {view==="grid" && <div className="border grid grid-cols-3 gap-6 mt-7">
                            <GridView />
                        </div>}
                ...
                <div className="border">
                    ...
                    <div className="border grid grid-cols-4 gap-6">
                        {/* card1 */}
