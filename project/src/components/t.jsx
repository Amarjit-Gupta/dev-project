...
const HeroSection = () => {
    return (
        <>
            {/* main content w-140 */}
            <div className="border h-120 flex items-center w-full bg-gray-300 hero-bg-img">
                <div className="border w-80 sm:w-140 xl:w-285 m-auto flex gap-5 justify-center">
                    <div className="border w-80 sm:w-140">
                    ...
                    <div className="border w-140 hidden xl:block">
                        {/* <div className="border">
                            <h1 className="text-32 text-primary font-semibold">Decision-orianted, not feature-orianted</h1>
                            <p className="text-16 text-primary font-regular mt-2 border">Comprehensive market trends, comsumer analysis and competitive landscape <br /> reports</p>
                        </div>
            ...
            <div className="border w-80 md:w-188 xl:w-285 m-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 py-18">

                {/* card 1 */}
                <div className="border p-4 w-80 md:w-91 h-54 flex flex-col justify-between bg-card1">
                    <div className="border">
                ...
                {/* card 2 */}
                <div className="border p-4 w-80 md:w-91 h-54 flex flex-col justify-between bg-card2">
                    <div className="border">
                ...
                {/* card 3 */}
                <div className="border p-4 w-80 md:w-91 h-54 flex flex-col justify-between bg-card3">
                    <div className="border">
            ...
            {/* why choose us*/}
            <div className="border bg-section">
                <div className="border py-18">
                    <h1 className="text-24 text-primary font-semibold text-center">Why Choose Us</h1>
                    <div className="border w-63.5 grid grid-cols-1 sm:w-138 sm:grid-cols-2 xl:w-287 xl:grid-cols-4 gap-11 pt-12  m-auto">
                        {/* card 1 */}
                        <div className="border w-63.5 h-72 content-center">
                            <div className="border h-30 w-30 m-auto"><img src={c1} alt="card1" /></div>
                        ...
                        {/* card 2 */}
                        <div className="border w-63.5 h-72 content-center">
                            <div className="border h-30 w-30 m-auto"><img src={c2} alt="card1" /></div>
                            <div className="border mt-3">
                        ...
                        {/* card 3 */}
                        <div className="border w-63.5 h-72 content-center">
                            <div className="border h-30 w-30 m-auto"><img src={c3} alt="card1" /></div>
                            <div className="border mt-3">
                        ...
                        {/* card 4 */}
                        <div className="border w-63.5 h-72 content-center">
                            <div className="border h-30 w-30 m-auto"><img src={c4} alt="card1" /></div>
                            <div className="border mt-3">
            ...
            <div className="border">
                <div className="border py-18">
                    ...
                    <div className="border w-80 sm:w-111 lg:w-225 xl:w-285 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-3 pt-12 m-auto">
                        {/* card 1 */}
            ...
            {/* Popular Reports  responsive done  */}
            <div className="border bg-section">
                <div className="border py-18">
                    <h1 className="text-24 text-primary font-semibold text-center">Popular Reports</h1>
                    <div className="border w-67 sm:w-140 grid grid-cols-1 sm:grid-cols-2 xl:w-285 xl:grid-cols-4 gap-6 pt-12 m-auto">
                        {/* card 1 */}

                        <div className="border h-102 w-67 bg-surface">
                            <div className="border h-[42%]">
                                ...
                                <div className="border mt-5 flex px-4 py-2 justify-between">
                            ...
                            <div className="border relative h-[58%]">
                                <img src={frame1} alt="image" className='h-full w-full' />
                                <div className="border absolute flex gap-2 px-4 bottom-4">
            ...
            <div className="border">
                <div className="border py-18">
                    ...
                    <div className="border w-80 grid grid-cols-1 sm:w-160 sm:grid-cols-2 xl:grid-cols-4 gap-6 py-20 xl:w-285 m-auto pt-12">
                        {/* card 1 */}
            ...
            <div className="border bg-section">
                <div className="border py-18">
                    ...
                    <div className="border w-80 flex flex-col lg:flex-row items-center gap-13 pt-12 lg:w-209 m-auto">
                        {/* card 1 */}
                        <div className="border w-44 h-45">
                            <div className='border h-25 w-25 m-auto'>
            ...
            <div className="border w-80 sm:w-160 lg:w-240 m-auto grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 xl:w-314 xl:grid-cols-7 gap-8.5 text-15 text-primary font-medium py-18">
...
const Navbar = () => {
    ...
    return (
        <>
            <div className="border h-21 w-full bg-surface flex justify-around items-center sticky top-0 left-0 z-50">
                <div className="border w-55 h-11"><img src={logo} alt="logo" className='h-full w-full' /></div>
                <button className='lg:hidden text-2xl' onClick={() => setMenu(!menu)}>{menu ? <span><RxCross2 /></span> : <span><RxHamburgerMenu /></span>}</button>
                <ul className={` transition-all duration-500 fixed top-21 lg:sticky lg:top-0 lg:w-auto w-full h-full lg:h-auto border text-center bg-surface ${menu ? "right-0" : "-right-[100%]"}`}>
