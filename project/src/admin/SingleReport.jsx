...
const SingleReport = () => {
    ...
    const getSingleReportData = async () => {
        try {
            setLoading(true);
            let result = await fetch(`https://vegetarian-begun-sets-configuration.trycloudflare.com/reports/${index}/preview`, {
                method: "GET",
                credentials: "include"
            });
    ...
    return (
        <div className="border w-230 m-auto p-4 h-150 overflow-auto my-4">
